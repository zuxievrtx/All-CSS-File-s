(function ($) {
  ...
  jQuery(document).ready(function ($) {
    ...
    productCenterCarousel.slick({
      ...
      responsive: [
        ...
        { breakpoint: 1199, settings: { centerPadding: "50px" } },
      ],
    });
    ...
    productSlideCarouselId.slick({
      ...
      responsive: [
        { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } },
        { breakpoint: 767, settings: { slidesToShow: 2, slidesToScroll: 1 } },
        { breakpoint: 1499, settings: { slidesToShow: 2, slidesToScroll: 2 } },
      ],
    });
    ...
    filterNamelayout2.on("click", function () {
      const filterValue = $(this).attr("data-filter");
      gridlayout2.isotope({ filter: filterValue });
      filterName.removeClass("active");
      $(this).addClass("active");
    });
    ...
    if (map_id.length > 0) {
      ...
      L.tileLayer
        .grayscale(
          "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png?access_token={accessToken}",
          {
            attribution: "Map",
            maxZoom: 18,
            id: "mapbox.streets",
    ...
    skills.each(function () {
      $(this).appear(function () {
        ...
        $(this)
          .find(".skill-percent")
          .html("<span>" + $(this).attr("data-percent") + "</span>");
      });
    });
    ...
    AOS.init({ disable: "mobile", once: true, offset: 200, duration: 1000 });
    ...
    if ($("#instafeed").length) {
      let feed = new Instafeed({
        ...
        accessToken:
          "IGQVJWRlI0cGpSWm44eW9qSklnV1hIclZArNi1zbW5xZAVZAZAYXVoYUo0TUtwNDNMQ2o5VzBxRDNTa1lNSHVzVHBWSEtSZAFR3NmlkSWlxZAlUwN2RBRjc2YWVwYWR4QldENFRLUDlCanpCNTBTOS1VMXh6LQZDZD",
      });
      feed.run();
    }
  ...
  jQuery(window).on("load", function () {
    ...
    if (parallaxActive.length) {
      myParaxify = paraxify(parallaxActive, { speed: 5, boost: 1 });
    }
  });
})(jQuery);
