  ...
  document.addEventListener("DOMContentLoaded", (event) => {
    if (typeof gsap !== typeof undefined) {
      ...
      if (jQuery("#home-1").length) {
        ...
        home1.from("#banner-image-bg", { scale: 0.9 });
        home1.from("#banner-image", { scale: 0.9 });
        gsap.from(".slider-2", {
          opacity: 0,
          x: 100,
          rotate: 90,
        ...
        document.addEventListener("mousemove", (e) => {
          let xPos = e.clientX * 0.01;
          let yPos = e.clientY * 0.01;
          // Change Elem For Movement
          gsap.to("#banner-slider-image", { x: xPos, y: yPos, duration: 0.5 });
        });
      }
      ...
      if (jQuery("#home-2").length) {
        ...
        // Mouse Move Animation
        document.addEventListener("mousemove", (e) => {
          let xPos = e.clientX * 0.008;
          let yPos = e.clientY * 0.008;
          // Change Elem For Movement
          gsap.to("#banner-slider2-image", { x: xPos, y: yPos, duration: 0.5 });
        });
      }
      ...
      if (jQuery("#home-3").length) {
        ...
        document.addEventListener("mousemove", (e) => {
          ...
          let yPos = e.clientY * 0.008;
          // Change Elem For Movement
          gsap.to("#banner-slider3-image", { x: xPos, y: yPos, duration: 0.5 });
        });
      }
      ...
      Array.from(animatedButton, (elem) => {
        elem.innerHTML =
          elem.textContent.replace(
            /\S/g,
            "<span class='anim d-inline-block'>$&</span>"
          ) +
